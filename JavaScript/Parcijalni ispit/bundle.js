...
var _default = exports["default"] = function _default() {
  ...
  var updateMusicList = /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            inputElementValue = document.getElementById('searchTerm').value; // Ako je upisano ime izvodzaca pretrazi pjesme inace ispisi noSongs
            ...
            if (retData.length !== 0) {
              ...
              for (i in retData) {
                ...
                if (retData[i].artist && retData[i].song) {
                  // Kreiraj li element
                  listItemElement = (0, _render.createElement)(retData[i]); // Dodaj kreirani li element ul-i
    ...
    return function updateMusicList() {
      return _ref.apply(this, arguments);
    };
  }();
...
},{"./data.js":1,"./render.js":4}],4:[function(require,module,exports){
"use strict";
