...
class App extends React.Component {
  ...
  render() {
    ...
    const showClearCompleted = visibility === VISIBILITY_TYPES.ALL || visibility === VISIBILITY_TYPES.COMPLETED;
    ...
    return (
      <div className="app">
          ...
          {hasCompleted && visibleTodos && showClearCompleted && <span className='btn-clear-all' onClick={this.handleRemoveCompleted}>Clear Completed</span>}
      </div>
    );
  }
}
