                  ...
                  while (1)
                    switch ((_context.prev = _context.next)) {
                      case 0:
                        ...
                        url = "https://itunes.apple.com/search?term=".concat(
                          inputElValue,
                          "&media=music"
                        );
                        _context.prev = 1;
                  ...
                  while (1)
                    switch ((_context.prev = _context.next)) {
                      case 0:
                        ...
                        inputElementValue =
                          document.getElementById("searchTerm").value; // Ako je upisano ime izvodzaca pretrazi pjesme inace ispisi noSongs
                        ...
                        if (retData.length !== 0) {
                          ...
                          for (i in retData) {
                            ...
                            if (retData[i].artist && retData[i].song) {
                              // Kreiraj li element
                              listItemElement = (0, _render.createElement)(
                                retData[i]
    ...
    4: [
      function (require, module, exports) {
        ...
        var createElement = (exports.createElement = function createElement(
          ...
          listItemP.innerHTML = ""
            .concat(songData.artist, " - ")
            .concat(songData.song);
